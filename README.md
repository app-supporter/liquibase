...
모듈간 연관관계는 다음과 같습니다. 모듈 간 불필요한 의존성 제거, 빌드 시간 단축을 위해 위해 Spring Data Jpa를 제외한 다른 의존성은 runtimeOnly 또는 imeimplementation을 사용했습니다. 
...
Spring Data Jpa는 다른 모듈에서 이를 사용할 경우, import를 하지 못하기 때문에 불가피하게 api를 사용했습니다.
