...
Spring Data Jpa를 imeimplementation으로 사용하면 (캡슐화로 인해) 다른 모듈에서 import를 할 수 없기 때문에 api를 사용하고 있습니다. 이는 도메인 모듈과 영속 모듈을 분리할 경우, imeimplementation을 사용할 수 있지만, 도메인 모델로 인해 늘어나는 코드량, 이로 인한 유지보수 비용이 더 크다고 판단했기 때문입니다.
